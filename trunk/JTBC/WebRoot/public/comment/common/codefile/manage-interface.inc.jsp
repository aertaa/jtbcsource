...
class module extends jpage
{
  ...
  private String Module_Action_Add()
  {
    ...
    tsqlstr += "'" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("ip")), 50) + "',";
  ...
  private String Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "ip") + "='" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("ip")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "content") + "='" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("content")), 10000) + "',";
    tsqlstr += cls.cfnames(tfpre, "keyword") + "='" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("keyword")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "fid") + "=" + cls.getNum(conf.getRequestUsParameter("fid"), 0) + ",";
