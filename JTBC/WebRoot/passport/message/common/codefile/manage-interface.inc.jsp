...
class module extends jpage
{
  ...
  private String Module_Action_Add()
  {
    ...
    tsqlstr += account.getUserID(conf.getRequestUsParameter("auusername")) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("auusername")), 50) + "',";
    tsqlstr += account.getUserID(conf.getRequestUsParameter("ruusername")) + ",";
    tsqlstr += "'" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("ruusername")), 50) + "',";
  ...
  private String Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "auid") + "=" + account.getUserID(conf.getRequestUsParameter("auusername")) + ",";
    tsqlstr += cls.cfnames(tfpre, "auusername") + "='" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("auusername")), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "ruid") + "=" + account.getUserID(conf.getRequestUsParameter("ruusername")) + ",";
    tsqlstr += cls.cfnames(tfpre, "ruusername") + "='" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("ruusername")), 50) + "',";
