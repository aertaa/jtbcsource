...
class module extends jpage
{
  ...
  private String Module_Action_Add()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "snum") + ",";
    tsqlstr += cls.cfnames(tfpre, "class") + ",";
    tsqlstr += cls.cfnames(tfpre, "image") + ",";
    tsqlstr += cls.cfnames(tfpre, "yprice") + ",";
    tsqlstr += cls.cfnames(tfpre, "xprice") + ",";
    tsqlstr += cls.cfnames(tfpre, "amount") + ",";
    ...
    tsqlstr += "'" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("snum")), 50) + "',";
    ...
    tsqlstr += cls.formatDouble(cls.getDouble(conf.getRequestUsParameter("yprice")), "0.00") + ",";
    tsqlstr += cls.formatDouble(cls.getDouble(conf.getRequestUsParameter("xprice")), "0.00") + ",";
    tsqlstr += cls.getNum(conf.getRequestUsParameter("amount"), 0) + ",";
  ...
  private String Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "snum") + "='" + cls.getLeft(encode.addslashes(conf.getRequestUsParameter("snum")), 50) + "',";
    ...
    tsqlstr += cls.cfnames(tfpre, "yprice") + "=" + cls.formatDouble(cls.getDouble(conf.getRequestUsParameter("yprice")), "0.00") + ",";
    tsqlstr += cls.cfnames(tfpre, "xprice") + "=" + cls.formatDouble(cls.getDouble(conf.getRequestUsParameter("xprice")), "0.00") + ",";
    tsqlstr += cls.cfnames(tfpre, "amount") + "=" + cls.getNum(conf.getRequestUsParameter("amount"), 0) + ",";
  ...
  private String Module_List()
  {
    ...
    if (tfield.equals("snum")) tsqlstr += " and " + cls.cfnames(tfpre, "snum") + " like '%" + tkeyword + "%'";
