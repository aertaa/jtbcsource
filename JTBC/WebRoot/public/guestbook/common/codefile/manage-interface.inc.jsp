...
class module extends jpage
{
  ...
  private String Module_Action_Edit()
  {
    ...
    tsqlstr += cls.cfnames(tfpre, "reply") + "='" + cls.getLeft(encode.addslashes(conf.common.repathencode(conf.getRequestUsParameter("reply"))), 100000) + "',";
    tsqlstr += cls.cfnames(tfpre, "rname") + "='" + cls.getLeft(encode.addslashes(admin.username), 50) + "',";
    tsqlstr += cls.cfnames(tfpre, "rtime") + "='" + cls.getDate(conf.getRequestUsParameter("rtime")) + "',";
